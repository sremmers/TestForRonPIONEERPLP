...
OhdsiRTools::checkUsagePackage("TestForRonPIONEERPLP")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/TestForRonPIONEERPLP.pdf")
shell("R CMD Rd2pdf ./ --output=extras/TestForRonPIONEERPLP.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "TestForRonPIONEERPLP")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("TestForRonPIONEERPLP")
