...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/TestForRonPIONEERPLP/inst/doc/UsingSkeletonPackage.pdf)

Instructions To Prepare Package Outside Atlas
===================

- Step 1: Change package name, readme and description (replace (TestForRonPIONEERPLP with the package name)
...
- Share the package by adding it to the OHDSI/StudyProtocolSandbox github repo and get people to install by running but replace 'TestForRonPIONEERPLP' with your study name if not using atlas:
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/TestForRonPIONEERPLP")
```

- Get users to execute the study by running the code in (extras/CodeToRun.R) but replace 'TestForRonPIONEERPLP' with your study name:
```r
  library(TestForRonPIONEERPLP)
  # USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./TestForRonPIONEERPLPResults"
...
cohortTable <- 'TestForRonPIONEERPLPCohort'
#=======================
...
viewShiny('TestForRonPIONEERPLP')
